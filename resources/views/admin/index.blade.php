...
<div class="layui-layout layui-layout-admin kit-layout-admin">
    <div class="layui-header">
        ...
        <div class="layui-logo kit-logo-mobile">MetaCoin</div>
    ...
    <div class="layui-side layui-bg-black kit-side">
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="kitNavbar" kit-navbar>
                ...
                <!-- <li class="layui-nav-item ">
                    <a class="" href="javascript:;"><i class="layui-icon layui-icon-username" aria-hidden="true"></i><span> 套餐管理</span></a>
                    <dl class="layui-nav-child">

                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/mining_machine',icon:'&#xe770;',title:'矿机管理',id:'121'}">
                                <i class="layui-icon">&#xe770;</i>
                                <span> 套餐管理</span>
                            </a>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/user_mining',icon:'&#xe770;',title:'用户矿机',id:'122'}">
                                <i class="layui-icon">&#xe770;</i>
                                <span> 用户套餐</span>
                            </a>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/user_mining/bonus',icon:'&#xe770;',title:'矿机分红',id:'123'}">
                                <i class="layui-icon">&#xe770;</i>
                                <span> 套餐分红</span>
                            </a>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/user_mining/mining_user_bonus',icon:'&#xe770;',title:'云算力客户列表',id:'124'}">
                                <i class="layui-icon">&#xe770;</i>
                                <span> 套餐客户列表</span>
                            </a>
                        </dd>
                ...
                <li class="layui-nav-item ">
                    <a class="" href="javascript:;"><i class="layui-icon layui-icon-username" aria-hidden="true"></i><span> 理财管理</span></a>
                    <dl class="layui-nav-child">

                        <dd>
                            <!-- <a href="javascript:;" kit-target data-options="{url:'/admin/financial',icon:'&#xe770;',title:'矿机管理',id:'121'}">
                                <i class="layui-icon">&#xe770;</i>
                                <span> 理财管理</span>
                            </a> -->
...
{{--                <li class="layui-nav-item ">--}}
{{--                    <a href="javascript:;"><i class="layui-icon layui-icon-chart" aria-hidden="true"></i><span> 杠杆交易</span></a>--}}
{{--                    <dl class="layui-nav-child">--}}
{{--                        <dd>--}}
...
{{--                </li>--}}
                ...
                <li class="layui-nav-item ">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" kit-target data-options="{url:'/admin/account/account_index', icon:'&#xe658;', title:'财务流水',id:'9'}"><i class="layui-icon">&#xe658;</i><span> 财务流水</span></a></dd>
                    </dl>
                    <dl class="layui-nav-child">
                    ...
                    <!-- <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/account/recharge_audit',icon:'&#xe659;',title:'充币审核',id:'100'}">
                                <i class="layui-icon">&#xe659;</i>
                                <span>充币审核</span>
                            </a>
                        </dd>
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/cashb',icon:'&#xe65e;',title:'提币列表',id:'17'}">
                                <i class="layui-icon">&#xe65e;</i>
                                <span> 提币列表</span>
                            </a>
                        </dd>
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/report/user',icon:'&#xe65e;',title:'团队报表',id:'17'}">
                                <i class="layui-icon">&#xe65e;</i>
                                <span>团队报表</span>
                            </a>
                        </dd>
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" kit-target data-options="{url:'/admin/agent_bonus_task/index',icon:'&#xe65e;',title:'收割列表',id:'18'}">
                                <i class="layui-icon">&#xe65e;</i>
                                <span>收割列表</span>
                            </a>
                        </dd>
