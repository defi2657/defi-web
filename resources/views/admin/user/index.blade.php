...
<script type="text/html" id="switchIsTransfer">
    <input type="checkbox" name="is_transfer" value="@{{d.id}}" lay-skin="switch" lay-text="是|否" @{{ d.is_transfer == 1 ? 'checked' : '' }} disabled>
</script>
...
<script type="text/html" id="switchIsAgent">
    <input type="checkbox" name="is_agent" value="@{{d.id}}" lay-skin="switch" lay-text="是|否"  @{{ d.is_agent == 1 ? 'checked' : '' }} disabled>
</script>
