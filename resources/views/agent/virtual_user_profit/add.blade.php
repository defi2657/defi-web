...
{{--    <link rel="stylesheet" type="text/css" href="{{URL("agent/common/bootstrap/css/bootstrap.css")}}" media="all">--}}
{{--    <link rel="stylesheet" type="text/css" href="{{URL("agent/common/global.css")}}" media="all">--}}
{{--    <link rel="stylesheet" type="text/css" href="{{URL("agent/css/personal.css")}}" media="all">--}}
@endsection
