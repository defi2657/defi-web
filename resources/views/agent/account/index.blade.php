    ...
    window.onload = function() {
        ...
        layui.use(['element', 'form', 'layer', 'table', 'laydate'], function() {
            ...
            form.on('submit(mobile_search)', function(obj) {
                ...
                var type = $('#type').val()
                tbRend("{{url('/agent/account/list')}}?account=" + account + '&type=' + type + '&start_time=' + start_time + '&end_time=' + end_time + '&currency_type=' + currency_type);
                return false;
            });
